...
class UIManager {
    ...
    private val defaultTexture = com.developersyndicate.kxengine.platform.KXPlatform.graphicsFactory.createTexture(1, 1, Color.WHITE)
    ...
    fun update(dt: Float) {
        val mouseX = Input.touchX
        // Flip Y coordinate to match OpenGL coordinates (bottom-left origin)
        val mouseY = EngineConfig.windowHeight - Input.touchY
        val isMouseDown = Input.isTouching
